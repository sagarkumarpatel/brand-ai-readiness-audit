...
class RecommendationEngine:
    ...
    ACTION_MAP = {
        "Missing Canonical": "Add a self-referencing canonical URL to the page and ensure it points to the preferred indexable URL.",
        ...
        "Sitemap/Crawl Barrier": "Ensure the robots.txt file and x-robots-tag headers do not block crawlers from accessing important pages, and that they are included in an XML sitemap.",
        "Conflicting Contact Information": "Choose the authoritative business phone number and update the conflicting first-party pages so the same canonical contact value is consistently published.",
        ...
        "Wall of Text": "Break up monolithic text blocks using semantic HTML headings (<h2>, <h3>) and lists to help AI models extract key sections, answers, and context accurately."
    }
